...
class CricketMatch:
    ...
    def coin_toss(self):
        """Toss section, team will choose to bat/bowl based on weather condition as well as Day/Night match.
            user input the weather condition and if the match is a Day or Night match
            p_choose_to : team2 choice after winning the toss
            j_choose_to : team1 choice after winning the toss
        ...
        if captain == self.t1players[0]:
            if flip_guessed[0] == flips[0]:
                print('{} wins the Toss and opted to {} first'.format(self.team2, p_choose_to))
            else:
                print('{} wins the Toss and opted to {} first'.format(self.team1, j_choose_to))
                p_choose_to = ''
        else:
            if flip_guessed[0] == flips[0]:
                print('{} wins the Toss and opted to {} first'.format(self.team1, j_choose_to))
        ...
        if j_choose_to == 'Bowl' or p_choose_to == 'Bat':
...
match = CricketMatch('Pune', 'Jaipur', 4, 40, *'players')
match.team1_players = ["Ramesh Sharma", "Rahul Soori", "Aayush Bumrah", "Shashi Tolley"]
match.team2_players = ['Vilas Kamothe', 'Amit Bedi']
match.coin_toss()
